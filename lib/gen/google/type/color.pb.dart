...
class Color extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Color', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.type'), createEmptyInstance: create)
    ...
    ..aOM<$18.FloatValue>(4, _omitFieldNames ? '' : 'alpha', subBuilder: $18.FloatValue.create)
  ...
  @$pb.TagNumber(4)
  $18.FloatValue get alpha => $_getN(3);
  @$pb.TagNumber(4)
  set alpha($18.FloatValue v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAlpha() => $_has(3);
  @$pb.TagNumber(4)
  void clearAlpha() => $_clearField(4);
  @$pb.TagNumber(4)
  $18.FloatValue ensureAlpha() => $_ensure(3);
}
