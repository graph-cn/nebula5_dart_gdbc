...
class Enum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Enum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..aOM<$30.SourceContext>(4, _omitFieldNames ? '' : 'sourceContext', subBuilder: $30.SourceContext.create)
  ...
  /// The source context.
  @$pb.TagNumber(4)
  $30.SourceContext get sourceContext => $_getN(3);
  @$pb.TagNumber(4)
  set sourceContext($30.SourceContext v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasSourceContext() => $_has(3);
  @$pb.TagNumber(4)
  void clearSourceContext() => $_clearField(4);
  @$pb.TagNumber(4)
  $30.SourceContext ensureSourceContext() => $_ensure(3);
...
class Option extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set value($6.Any v) { $_setField(2, v); }
  @$pb.TagNumber(2)
