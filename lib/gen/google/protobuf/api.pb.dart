...
import 'source_context.pb.dart' as $30;
import 'type.pb.dart' as $10;
import 'type.pbenum.dart' as $10;
...
class Api extends $pb.GeneratedMessage {
  factory Api({
    ...
    $core.Iterable<$10.Option>? options,
    $core.String? version,
    $30.SourceContext? sourceContext,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Api', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..pc<$10.Option>(3, _omitFieldNames ? '' : 'options', $pb.PbFieldType.PM, subBuilder: $10.Option.create)
    ..aOS(4, _omitFieldNames ? '' : 'version')
    ..aOM<$30.SourceContext>(5, _omitFieldNames ? '' : 'sourceContext', subBuilder: $30.SourceContext.create)
    ..pc<Mixin>(6, _omitFieldNames ? '' : 'mixins', $pb.PbFieldType.PM, subBuilder: Mixin.create)
    ..e<$10.Syntax>(7, _omitFieldNames ? '' : 'syntax', $pb.PbFieldType.OE, defaultOrMaker: $10.Syntax.SYNTAX_PROTO2, valueOf: $10.Syntax.valueOf, enumValues: $10.Syntax.values)
  ...
  @$pb.TagNumber(3)
  $pb.PbList<$10.Option> get options => $_getList(2);
  ...
  /// message.
  @$pb.TagNumber(5)
  $30.SourceContext get sourceContext => $_getN(4);
  @$pb.TagNumber(5)
  set sourceContext($30.SourceContext v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSourceContext() => $_has(4);
  @$pb.TagNumber(5)
  void clearSourceContext() => $_clearField(5);
  @$pb.TagNumber(5)
  $30.SourceContext ensureSourceContext() => $_ensure(4);
  ...
  @$pb.TagNumber(7)
  $10.Syntax get syntax => $_getN(6);
  @$pb.TagNumber(7)
  set syntax($10.Syntax v) { $_setField(7, v); }
  @$pb.TagNumber(7)
...
class Method extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Method', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..pc<$10.Option>(6, _omitFieldNames ? '' : 'options', $pb.PbFieldType.PM, subBuilder: $10.Option.create)
    ..e<$10.Syntax>(7, _omitFieldNames ? '' : 'syntax', $pb.PbFieldType.OE, defaultOrMaker: $10.Syntax.SYNTAX_PROTO2, valueOf: $10.Syntax.valueOf, enumValues: $10.Syntax.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $pb.PbList<$10.Option> get options => $_getList(5);
