...
class FileDescriptorProto extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(14)
  set edition(Edition v) { $_setField(14, v); }
  @$pb.TagNumber(14)
...
class ExtensionRangeOptions extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set verification(ExtensionRangeOptions_VerificationState v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(50)
  set features(FeatureSet v) { $_setField(50, v); }
  @$pb.TagNumber(50)
...
class FileOptions extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(999)
  $pb.PbList<UninterpretedOption> get uninterpretedOption => $_getList(21);
}
...
class MessageOptions extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(12)
  set features(FeatureSet v) { $_setField(12, v); }
  @$pb.TagNumber(12)
...
class FieldOptions_EditionDefault extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set edition(Edition v) { $_setField(3, v); }
  @$pb.TagNumber(3)
...
class FieldOptions extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(17)
  set retention(FieldOptions_OptionRetention v) { $_setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(21)
  set features(FeatureSet v) { $_setField(21, v); }
  @$pb.TagNumber(21)
  ...
  /// The parser stores options it doesn't recognize here. See above.
  @$pb.TagNumber(999)
  $pb.PbList<UninterpretedOption> get uninterpretedOption => $_getList(12);
}
...
class OneofOptions extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set features(FeatureSet v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class EnumOptions extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(7)
  set features(FeatureSet v) { $_setField(7, v); }
  @$pb.TagNumber(7)
...
class EnumValueOptions extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set features(FeatureSet v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class ServiceOptions extends $pb.GeneratedMessage {
  ...
  FeatureSet get features => $_getN(1);
  @$pb.TagNumber(34)
  set features(FeatureSet v) { $_setField(34, v); }
  @$pb.TagNumber(34)
  $core.bool hasFeatures() => $_has(1);
  @$pb.TagNumber(34)
...
class MethodOptions extends $pb.GeneratedMessage {
  ...
  FeatureSet get features => $_getN(2);
  @$pb.TagNumber(35)
  set features(FeatureSet v) { $_setField(35, v); }
  @$pb.TagNumber(35)
  $core.bool hasFeatures() => $_has(2);
  @$pb.TagNumber(35)
...
class FeatureSet extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set fieldPresence(FeatureSet_FieldPresence v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set enumType(FeatureSet_EnumType v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set repeatedFieldEncoding(FeatureSet_RepeatedFieldEncoding v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set utf8Validation(FeatureSet_Utf8Validation v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set messageEncoding(FeatureSet_MessageEncoding v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set jsonFormat(FeatureSet_JsonFormat v) { $_setField(6, v); }
  @$pb.TagNumber(6)
...
class FeatureSetDefaults extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set minimumEdition(Edition v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set maximumEdition(Edition v) { $_setField(5, v); }
  @$pb.TagNumber(5)
...
class GeneratedCodeInfo_Annotation extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set semantic(GeneratedCodeInfo_Annotation_Semantic v) { $_setField(5, v); }
  @$pb.TagNumber(5)
