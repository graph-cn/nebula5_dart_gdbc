...
class HttpBody extends $pb.GeneratedMessage {
  factory HttpBody({
    ...
    $core.Iterable<$6.Any>? extensions,
  }) {
    final $result = create();
    if (contentType != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'HttpBody', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ...
    ..pc<$6.Any>(3, _omitFieldNames ? '' : 'extensions', $pb.PbFieldType.PM, subBuilder: $6.Any.create)
  ...
  /// for streaming APIs.
  @$pb.TagNumber(3)
  $pb.PbList<$6.Any> get extensions => $_getList(2);
}
