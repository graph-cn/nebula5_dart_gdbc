...
class ClientLibrarySettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientLibrarySettings', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ...
    ..e<$4.LaunchStage>(2, _omitFieldNames ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $4.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $4.LaunchStage.valueOf, enumValues: $4.LaunchStage.values)
  ...
  @$pb.TagNumber(2)
  $4.LaunchStage get launchStage => $_getN(1);
  @$pb.TagNumber(2)
  set launchStage($4.LaunchStage v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class MethodSettings_LongRunning extends $pb.GeneratedMessage {
  factory MethodSettings_LongRunning({
    $3.Duration? initialPollDelay,
    $core.double? pollDelayMultiplier,
    $3.Duration? maxPollDelay,
    $3.Duration? totalPollTimeout,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MethodSettings.LongRunning', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ..aOM<$3.Duration>(1, _omitFieldNames ? '' : 'initialPollDelay', subBuilder: $3.Duration.create)
    ..a<$core.double>(2, _omitFieldNames ? '' : 'pollDelayMultiplier', $pb.PbFieldType.OF)
    ..aOM<$3.Duration>(3, _omitFieldNames ? '' : 'maxPollDelay', subBuilder: $3.Duration.create)
    ..aOM<$3.Duration>(4, _omitFieldNames ? '' : 'totalPollTimeout', subBuilder: $3.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $3.Duration get initialPollDelay => $_getN(0);
  @$pb.TagNumber(1)
  set initialPollDelay($3.Duration v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasInitialPollDelay() => $_has(0);
  @$pb.TagNumber(1)
  void clearInitialPollDelay() => $_clearField(1);
  @$pb.TagNumber(1)
  $3.Duration ensureInitialPollDelay() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $3.Duration get maxPollDelay => $_getN(2);
  @$pb.TagNumber(3)
  set maxPollDelay($3.Duration v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMaxPollDelay() => $_has(2);
  @$pb.TagNumber(3)
  void clearMaxPollDelay() => $_clearField(3);
  @$pb.TagNumber(3)
  $3.Duration ensureMaxPollDelay() => $_ensure(2);

  /// Total polling timeout.
  /// Default value: 5 minutes.
  @$pb.TagNumber(4)
  $3.Duration get totalPollTimeout => $_getN(3);
  @$pb.TagNumber(4)
  set totalPollTimeout($3.Duration v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTotalPollTimeout() => $_has(3);
  @$pb.TagNumber(4)
  void clearTotalPollTimeout() => $_clearField(4);
  @$pb.TagNumber(4)
  $3.Duration ensureTotalPollTimeout() => $_ensure(3);
}
