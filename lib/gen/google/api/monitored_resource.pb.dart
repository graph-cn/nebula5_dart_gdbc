...
class MonitoredResourceDescriptor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MonitoredResourceDescriptor', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ...
    ..pc<$7.LabelDescriptor>(4, _omitFieldNames ? '' : 'labels', $pb.PbFieldType.PM, subBuilder: $7.LabelDescriptor.create)
    ..aOS(5, _omitFieldNames ? '' : 'name')
    ..e<$4.LaunchStage>(7, _omitFieldNames ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $4.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $4.LaunchStage.valueOf, enumValues: $4.LaunchStage.values)
  ...
  @$pb.TagNumber(4)
  $pb.PbList<$7.LabelDescriptor> get labels => $_getList(3);
  ...
  @$pb.TagNumber(7)
  set launchStage($4.LaunchStage v) { $_setField(7, v); }
  @$pb.TagNumber(7)
...
class MonitoredResourceMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MonitoredResourceMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ..aOM<$8.Struct>(1, _omitFieldNames ? '' : 'systemLabels', subBuilder: $8.Struct.create)
  ...
  ///        "spot_instance": false }
  @$pb.TagNumber(1)
  $8.Struct get systemLabels => $_getN(0);
  @$pb.TagNumber(1)
  set systemLabels($8.Struct v) { $_setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSystemLabels() => $_has(0);
  @$pb.TagNumber(1)
  void clearSystemLabels() => $_clearField(1);
  @$pb.TagNumber(1)
  $8.Struct ensureSystemLabels() => $_ensure(0);
