...
class SourceInfo extends $pb.GeneratedMessage {
  factory SourceInfo({
    $core.Iterable<$6.Any>? sourceFiles,
  }) {
    final $result = create();
    if (sourceFiles != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SourceInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ..pc<$6.Any>(1, _omitFieldNames ? '' : 'sourceFiles', $pb.PbFieldType.PM, subBuilder: $6.Any.create)
  ...
  @$pb.TagNumber(1)
  $pb.PbList<$6.Any> get sourceFiles => $_getList(0);
}
