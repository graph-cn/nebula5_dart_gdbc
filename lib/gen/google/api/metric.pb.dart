...
class MetricDescriptor_MetricDescriptorMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetricDescriptor.MetricDescriptorMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ..e<$4.LaunchStage>(1, _omitFieldNames ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $4.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $4.LaunchStage.valueOf, enumValues: $4.LaunchStage.values)
    ..aOM<$3.Duration>(2, _omitFieldNames ? '' : 'samplePeriod', subBuilder: $3.Duration.create)
    ..aOM<$3.Duration>(3, _omitFieldNames ? '' : 'ingestDelay', subBuilder: $3.Duration.create)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  set launchStage($4.LaunchStage v) { $_setField(1, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $3.Duration get samplePeriod => $_getN(1);
  @$pb.TagNumber(2)
  set samplePeriod($3.Duration v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSamplePeriod() => $_has(1);
  @$pb.TagNumber(2)
  void clearSamplePeriod() => $_clearField(2);
  @$pb.TagNumber(2)
  $3.Duration ensureSamplePeriod() => $_ensure(1);

  /// The delay of data points caused by ingestion. Data points older than this
  /// age are guaranteed to be ingested and available to be read, excluding
  /// data loss due to errors.
  @$pb.TagNumber(3)
  $3.Duration get ingestDelay => $_getN(2);
  @$pb.TagNumber(3)
  set ingestDelay($3.Duration v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasIngestDelay() => $_has(2);
  @$pb.TagNumber(3)
  void clearIngestDelay() => $_clearField(3);
  @$pb.TagNumber(3)
  $3.Duration ensureIngestDelay() => $_ensure(2);
}
...
class MetricDescriptor extends $pb.GeneratedMessage {
  factory MetricDescriptor({
    $core.String? name,
    $core.Iterable<$7.LabelDescriptor>? labels,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MetricDescriptor', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ...
    ..pc<$7.LabelDescriptor>(2, _omitFieldNames ? '' : 'labels', $pb.PbFieldType.PM, subBuilder: $7.LabelDescriptor.create)
    ...
    ..e<$4.LaunchStage>(12, _omitFieldNames ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $4.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $4.LaunchStage.valueOf, enumValues: $4.LaunchStage.values)
  ...
  @$pb.TagNumber(2)
  $pb.PbList<$7.LabelDescriptor> get labels => $_getList(1);
  ...
  @$pb.TagNumber(3)
  set metricKind(MetricDescriptor_MetricKind v) { $_setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set valueType(MetricDescriptor_ValueType v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(10)
  set metadata(MetricDescriptor_MetricDescriptorMetadata v) { $_setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set launchStage($4.LaunchStage v) { $_setField(12, v); }
  @$pb.TagNumber(12)
