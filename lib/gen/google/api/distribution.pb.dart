...
class Distribution_BucketOptions extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set exponentialBuckets(Distribution_BucketOptions_Exponential v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class Distribution_Exemplar extends $pb.GeneratedMessage {
  factory Distribution_Exemplar({
    ...
    $core.Iterable<$6.Any>? attachments,
  }) {
    final $result = create();
    if (value != null) {
      $result.value = value;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Distribution.Exemplar', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.api'), createEmptyInstance: create)
    ...
    ..pc<$6.Any>(3, _omitFieldNames ? '' : 'attachments', $pb.PbFieldType.PM, subBuilder: $6.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set timestamp($5.Timestamp v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  $pb.PbList<$6.Any> get attachments => $_getList(2);
}
...
class Distribution extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  set range(Distribution_Range v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set bucketOptions(Distribution_BucketOptions v) { $_setField(6, v); }
  @$pb.TagNumber(6)
