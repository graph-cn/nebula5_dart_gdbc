...
class Operation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Operation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.longrunning'), createEmptyInstance: create)
    ...
    ..aOM<$6.Any>(2, _omitFieldNames ? '' : 'metadata', subBuilder: $6.Any.create)
    ..aOB(3, _omitFieldNames ? '' : 'done')
    ..aOM<$29.Status>(4, _omitFieldNames ? '' : 'error', subBuilder: $29.Status.create)
    ..aOM<$6.Any>(5, _omitFieldNames ? '' : 'response', subBuilder: $6.Any.create)
  ...
  @$pb.TagNumber(2)
  $6.Any get metadata => $_getN(1);
  @$pb.TagNumber(2)
  set metadata($6.Any v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMetadata() => $_has(1);
  @$pb.TagNumber(2)
  void clearMetadata() => $_clearField(2);
  @$pb.TagNumber(2)
  $6.Any ensureMetadata() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $29.Status get error => $_getN(3);
  @$pb.TagNumber(4)
  set error($29.Status v) { $_setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasError() => $_has(3);
  @$pb.TagNumber(4)
  void clearError() => $_clearField(4);
  @$pb.TagNumber(4)
  $29.Status ensureError() => $_ensure(3);
  ...
  @$pb.TagNumber(5)
  $6.Any get response => $_getN(4);
  @$pb.TagNumber(5)
  set response($6.Any v) { $_setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasResponse() => $_has(4);
  @$pb.TagNumber(5)
  void clearResponse() => $_clearField(5);
  @$pb.TagNumber(5)
  $6.Any ensureResponse() => $_ensure(4);
}
...
class WaitOperationRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WaitOperationRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.longrunning'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$3.Duration>(2, _omitFieldNames ? '' : 'timeout', subBuilder: $3.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set timeout($3.Duration v) { $_setField(2, v); }
  @$pb.TagNumber(2)
